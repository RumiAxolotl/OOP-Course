 ...
 */
public class Money {
    private double dollars; // The number of dollars
    private double cents; // The number of cents
    ...
    public Money(double amount) {
        if (amount < 0) {
            ...
            double allCents = Math.round(amount * 100);
...
//    }
    ...
    public Money add(Money otherAmount) {
        ...
        double carryDollars = sum.cents / 100;
