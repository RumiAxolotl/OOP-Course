...
public class DiceSimulation
{
    public static void main(String[] args)
    {
        ...
        int die1Value, die2Value; // Value of the first die and the second die
        ...
        while(count < NUMBER) {
            die1Value = rd.nextInt(6) + 1;
            die2Value = rd.nextInt(6) + 1;
        ...
        // TASK #2 Enter your code for the algorithm here
        // do-while loop
        do {
            die1Value = rd.nextInt(6) + 1;
            die2Value = rd.nextInt(6) + 1;
